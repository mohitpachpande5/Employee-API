...
public class PostgreSQLJDBC {
   ...
   // private static final String URL = "jdbc:postgresql://localhost:5432/";
    ...
    public static void createDatabase(String dbName) {
        ...
        try (Connection conn = DriverManager.getConnection(NEW_URL, USER, PASSWORD);
    ...
    public static void createTable(String tableName) {
        ...
        try (Connection conn = DriverManager.getConnection(NEW_URL + DB_NAME, USER, PASSWORD);
             Statement stmt = conn.createStatement()) {
            stmt.executeUpdate(sql);
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("8. Show All Table");
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    System.out.println("All Table from DB...");
                   showAllTables();
                    break;
                case 9:
